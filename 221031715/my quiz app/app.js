var questions = [
    ...
    {
        question: "The best footballer of all time?",
        answer: "Lionel Messi",
        options: [
            "Pele",
            "Diego Maradonna",
...
function discardRec(id) {
    ...
    // Assume `numCorrect` and `numIncorrect` are variables that store the number of correct and incorrect answers
data.datasets[0].data = [numCorrect, numIncorrect];
myPieChart.update();
